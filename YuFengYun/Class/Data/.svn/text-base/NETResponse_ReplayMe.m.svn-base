...
@implementation NETResponse_ReplayMe
...
- (void)setResponseDic:(NSDictionary *)responseDic {
    if (_responseDic != responseDic) {
        ...
        for (NSDictionary *resultDic in resultArr) {
            NETResponse_ReplayMe_Result *result = [[NETResponse_ReplayMe_Result alloc] init];
...
@implementation NETResponse_ReplayMe_Result

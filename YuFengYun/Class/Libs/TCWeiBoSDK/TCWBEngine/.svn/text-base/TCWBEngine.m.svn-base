...
//static TCWBEngine * g_engine = nil;
//+(TCWBEngine*)sharedInstance
//{
//    
//    
//    if (g_engine == nil)
//    {
//        g_engine = [[TCWBEngine alloc] init];
//        
//    }
//    return g_engine;
//}

//-(void) setRootViewController2:(UIViewController *)rootViewController_
//{
...
//    }
//    
//    self.rootViewController = [rootViewController_ retain];
//}
...
//    if(g_engine)
//    {
//        g_engine.appKey = theAppKey;
//        g_engine.appSecret = theAppSecret;
//        g_engine.redirectURI = theRedirectUrl;
//        
//        httpRequests = [[NSMutableArray alloc] initWithCapacity:2];
//        [g_engine readAuthorizeDataFromKeychain];
//        g_engine.rootViewController = nil;
//        g_engine.isRefreshTokenSuccess = YES;
//    }else
    if ((self = [super init])){
...
//    NSLog(@"\n %@\n %f\n %@\n %@", self.accessToken, self.expireTime, self.openId, self.refreshToken);
    if (![self isAuthorizeExpired] && self.openId && self.accessToken) {
        if ([requestDelegate respondsToSelector:successCallback]) {
            [requestDelegate performSelector:onSuccessCallback];
        }
        return;
    }

...
@implementation Discuss_Title_Cell
...
//                                  limitSize:CGSizeMake(self.detailLabel.frame.size.width, 1000)];
    ...
    float y = rect.origin.y + rect.size.height + 7;
    CGRect rect2 = self.titleView.frame;
    rect2.origin.y = y;
    self.titleView.frame = rect2;

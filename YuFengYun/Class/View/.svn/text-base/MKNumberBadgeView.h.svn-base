...
typedef enum {
	...
	NumberTransformStyleRollOver,                         //roll 3/2 PI by the y axis (x, z rotation)
	NumberTransformStyleShrinkInOut,
    NumberTransformStyleShake,
} NumberTransformStyle;

@interface MKNumberBadgeView (animation)

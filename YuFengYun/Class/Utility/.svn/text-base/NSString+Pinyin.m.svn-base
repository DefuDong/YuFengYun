...
- (NSString *)pinyinString {
    ...
    char letterStr[len + 1];
    for (NSInteger i = 0; i < len; i++) {
//        letterStr[i] = pinyinFirstLetter([self characterAtIndex:i]);
        letterStr[i] = [NSString pinyinFirstLetter:[self characterAtIndex:i]];
    }
    letterStr[len] = '\0';
    return [NSString stringWithCString:(const char *)letterStr encoding:NSUTF8StringEncoding];
}
